...
class Message(models.Model):
    creator_id = models.ForeignKey(User, related_name='sender', on_delete=models.PROTECT)
    recipient_id = models.ForeignKey(User, related_name='reciever' ,on_delete=models.PROTECT)
